/**
 * @name PasteAndSend
 * @description Adds a paste and send button to context menus in messages so you can send clipboard items without having to let go off your mouse.
 * @author ak-tr
 * @version 1.0.0
 */
/******/ (() => { // webpackBootstrap
...
var ContextMenu = BdApi.ContextMenu;
var navId = "textarea-context";
// Extract callback to global scope as it is required for unpatching
var callback = function (tree, props) {
